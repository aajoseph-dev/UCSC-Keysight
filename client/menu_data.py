test_steps = {
            ...
            "Power Source": [
                ...
                "Perform dynamic voltage testing"
            ],
            "Power Products": [
                "Set output voltage",
                ...
                "Verify output voltage",
                "Verify output current",
                "Perform power stability testing"
            ],
            "Oscilloscope": [
                "Adjust timebase settings",
            ...
            "Other": [
                ...
                "Analyze non-standard scenarios",
